...
% FullSolution by removing bad data and interpolating vertically wherever necessary.
...
% Only use when running without sample-specific GEMS
...
load('data/output/FullSolution_L1.mat')
...
if Options.samplespecific
    load(strcat('/Users/tatsurotanioka/Desktop/Project/BioGOSHIP_MetaPanGEM/Metagenome_GEM/models/SampleMod_Merged_',alpha_level,'.mat'));
    if strcmp(alpha_level,'alpha95');
        StrMod = SampleMod_Merged_alpha95;
    elseif strcmp(alpha_level,'alpha90');
...
save(strcat(runPath,'/data/output/FullSolution_L2.mat'),'FullSolution_L2');
